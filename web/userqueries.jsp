...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NED ADMISSION QUERY PORTAL | User Queries</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="userqueries.jsp"><i class="fa fa-dashboard"></i> User</a></li>
             ...
             try
                      ...
                      while((s = br.readLine()) != null) { 
                       str2 = s.split(",");
                        if(!numbers.contains(str2[1])){
       numbers.add(str2[1]);
}
                      }
                     
                  // out.println(numbers.get(1));
                      fw.close();
                      } catch (Exception e) {
                      e.printStackTrace();
                      }
...
<table style="width:100%; background-color: white; ">
    <tbody> <tr>
    <th style="color: black">STUDENT_ID</th>
    <th>Queries</th>
  </tr>
  <tr>
    <td><% out.println(numbers.get(1)); %> </td>
    <td><a href="findquery.jsp?email=<% out.println(numbers.get(1)); %>">Reply to Query</a></td> 
  </tr>
    </tbody>
</table>
            </div><!-- /.row (main row) -->
